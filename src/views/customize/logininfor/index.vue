    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['customize:logininfor:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['customize:logininfor:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['customize:logininfor:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['customize:logininfor:export']"
        >导出
        </el-button>
      </el-col>
...
<script>
  import {getLogininfor, listLogininfor} from "@/api/";
  ...
  /** 导出按钮操作 */
  handleExport() {
    this.download('customize/logininfor/export', {
      ...this.queryParams
