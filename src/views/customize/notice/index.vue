    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['customize:notice:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['customize:notice:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['customize:notice:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['customize:notice:export']"
        >导出
        </el-button>
      </el-col>
...
<script>
  import {getNotice, listNotice} from "@/api/";
  ...
  /** 导出按钮操作 */
  handleExport() {
    this.download('customize/notice/export', {
      ...this.queryParams
