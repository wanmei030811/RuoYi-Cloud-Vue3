<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
                  <el-form-item label="公司id" prop="companId">
                    <el-input
                        v-model="queryParams.companId"
                        placeholder="请输入公司id"
                        clearable
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['customize:page:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['customize:page:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            icon="Download"
            @click="handleExport"
            v-hasPermi="['customize:page:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="pageList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="公司id" align="center" prop="companId" />
              <el-table-column label="系统id" align="center" prop="systemId" />
              <el-table-column label="菜单id" align="center" prop="menuId" />
              <el-table-column label="页面主键" align="center" prop="pageId" />
              <el-table-column label="页面标签" align="center" prop="pageLabel" />
              <el-table-column label="页面名称" align="center" prop="pageName" />
              <el-table-column label="json数据" align="center" prop="json" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['customize:page:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['customize:page:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="pageRef" :model="form" :rules="rules" label-width="80px">
                        <el-form-item label="公司id" prop="companId">
                          <el-input v-model="form.companId" placeholder="请输入公司id" />
                        </el-form-item>
                        <el-form-item label="系统id" prop="systemId">
...
<script setup name="Page">
  import { listPage, getPage, delPage, addPage, updatePage } from "@/api/customize/page";
  ...
  function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除页面编号为"' + _pageIds + '"的数据项？').then(function() {
  ...
  function handleExport() {
    proxy.download('customize/page/export', {
      ...queryParams.value
